...
public class PdfGeneratorAdapter implements PdfGeneratorOutputPort {
  ...
  private static final String[] HEADERS = {"Fecha", "Cliente", "Número Cuenta", "Tipo", "Estado", "Movimiento", "Saldo Inicial", "Valor", "Saldo"};
    ...
    return Mono.fromCallable(() -> {
      try {
        ...
        for (ReportResponseDto report : reports) {
          ...
          table.addCell(new Phrase(report.getStatus() != null ? (report.getStatus() ? "Activa" : "Inactiva") : "", dataFont));
