...
import static com.challenge.account.infrastructure.exception.utils.Constants.BAD_REQUEST;
import static com.challenge.account.infrastructure.exception.utils.Constants.FIELDS_ARE_NOT_CORRECT;
import static com.challenge.account.infrastructure.exception.utils.Constants.INTERNAL_SERVER_ERROR_AN_UNEXPECTED_ERROR_OCCURRED;
import static com.challenge.account.infrastructure.exception.utils.Constants.NOT_FOUND;
import static com.challenge.account.infrastructure.exception.utils.Constants.UNEXPECTED_ERROR;
import static com.challenge.account.infrastructure.exception.utils.ExceptionUtils.buildErrorDto;
import static com.challenge.account.infrastructure.exception.utils.ExceptionUtils.buildErrorsDto;
import static com.challenge.account.infrastructure.exception.utils.ExceptionUtils.buildResponseEntity;
